import '../onboarding_one_screen/widgets/tradetext_item_widget.dart';
...
class OnboardingOneScreen extends StatelessWidget {
          ...
          child: SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildEightyFiveStack(context),
                SizedBox(height: 13.v),
                _buildOnboardingOneColumn(context),
              ],
            ),
          ),
        ),
  ...
  /// Section Widget
  Widget _buildEightyFiveStack(BuildContext context) {
    return SizedBox(
      height: 387.v,
      width: double.maxFinite,
      child: Stack(
        ...
        children: [
          CustomImageView(
            imagePath: ImageConstant.imgGroup10239,
            height: 369.v,
            width: 331.h,
  ...
  /// Section Widget
  Widget _buildOnboardingOneColumn(BuildContext context) {
    return Container(
